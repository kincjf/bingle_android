...
//            ArrayList<Integer> arr_byte = new ArrayList<Integer>();
            ...
            final byte PRE_HEADER = 0x0;
            final byte COMMAND_ID = 0x0;
            while (true) {
...
//                기존 데이터를 받는 형태에서의 문제점 : 케리지 리턴 형태의 데이터가 아니기 때문에 원활한 수신이 불가능하여 개선함
//                try {
...
//                call_lock.lock();
                ...
                if (mmInStream.available() > 4) {
                    int available = 0;
                        ...
                        }while(mmInStream.available()!=available);
                        //패킷이 타당하지 않은 형태의 것인지를 판단
                    synchronized (this){
